...
function draw()
{
	...
	fill(random(10, 200), 0, random(10, 200));
	...
	if (robot1_x + robot1Speed_x >= 500 || robot1_x + robot1Speed_x <= 0){
		robot1Speed_x = robot1Speed_x * (-1);
	}

	if (robot1_y + robot1Speed_y >= 600 || robot1_y + robot1Speed_y <= 0){
		robot1Speed_y = robot1Speed_y * (-1);
	}


	if (robot2_x + robot2Speed_x >= 500 || robot2_x + robot2Speed_x <= 0){
		robot2Speed_x = robot2Speed_x * (-1);
	}

	if (robot2_y + robot2Speed_y >= 600 || robot2_y + robot2Speed_y <= 0){
		robot2Speed_y = robot2Speed_y * (-1);
	}

	if(robot1_x - robot2_x >= -100 && robot1_x - robot2_x <= 100 && 
		robot1_y - robot2_y >= -100 && robot1_y - robot2_y <= 100){
		tempx = robot1Speed_x;
		tempy = robot1Speed_y;
		robot1Speed_x = robot2Speed_x;
		robot1Speed_y = robot2Speed_y;
		robot2Speed_x = tempx;
		robot2Speed_y = tempy;
	}
