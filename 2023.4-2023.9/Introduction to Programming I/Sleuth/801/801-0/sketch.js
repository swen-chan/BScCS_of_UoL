...
Officer: 1450836
CaseNum: 801-0-11106323-1450836

At the rotten core of Console City are a series of secretive orders 
 who pull all the criminal strings.
 If we get to them we can clean up this town for good. 

Now we have a chance - the Order of The Knuth's will be 
at the command performance of Rigoletto at the console city Opera house tonight. 
Our person on the inside is working the box office. 
We’ve got intell and access to the lighting desk. 
...
var patrons = [ [ { x: 50, y: 50, identified: false} , 
...
function draw()
{
	...
	patrons[9][4].identified = true;
	patrons[8][1].identified = true;
	patrons[5][2].identified = true;
	patrons[4][3].identified = true;
	patrons[8][4].identified = true;
	patrons[6][1].identified = true;
	patrons[7][9].identified = true;
