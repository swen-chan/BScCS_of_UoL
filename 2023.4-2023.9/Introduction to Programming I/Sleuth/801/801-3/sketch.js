...
Officer: 1450836
CaseNum: 801-3-75900347-1450836

We have a chance to record the powerful Order of Tukey 
before the curtain comes down on the Marriage of Figaro. 
They might be the most influential group in console city but they still have their quirks 
and will be spotable thanks their trademark beard.
...
Ticket stubbs are marked with true if they are in the gang. 
...
var viewers = [ [ { x: 50, y: 50, highlighted: false} , 
...
function draw()
{
	...
	for(i = 0; i < 10; i++){
		for(j = 0; j < 10; j++){
			viewers[i][j].highlighted = wanted[i*10 + j];
		}
	}
