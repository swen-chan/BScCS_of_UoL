...
Officer: 1450836
CaseNum: 802-0-75531925-1450836
...
a company used by the shady politicians of Console City 
to make them seem more popular than they really are.

They’re prepared to give up the dirt on their techniques 
if we can beat them in a game of 5 card stud poker. 
...
- Inside the function, use a for loop to 
set the marked property of the card_deck array elements to true 
when the suit is Diamonds or the value is 4
...
function pick_cards(){
	for(i = 0; i < card_deck.length; i++){
		if(card_deck[i].card_suit == 'Diamonds' || card_deck[i].no == '4'){
