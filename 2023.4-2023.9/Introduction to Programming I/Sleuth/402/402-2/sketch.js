...
Officer: 1450836
CaseNum: 402-2-93658146-1450836
...
function draw()
{
	...
	else if(det.locationY > 440)
	{
		//turn north
		det.speedX = 0;
		det.speedY = -1;
	}
	else if(det.locationX > 510)
	{
		//turn west
		det.speedX = -1;
		det.speedY = 0;
	...
	else if(det.locationX > 320)
	{
		//turn west
		det.speedX = -1;
		det.speedY = 0;
	}
	else if(det.locationY > 70)
	{
		//turn north
		det.speedX = 0;
		det.speedY = -1;
	}
	else if(det.locationX > 140)
	{
		//turn west
		det.speedX = -1;
		det.speedY = 0;
