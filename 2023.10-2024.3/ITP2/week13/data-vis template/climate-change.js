function ClimateChange() {
  ...
  this.setup = function() {
    ...
    //debug
    // this.startSlider.input(() => {this.startYear = this.startSlider.value();});
    ...
    //debug
    // this.endSlider.input(() => {this.endYear = this.endSlider.value();});
  };
  ...
  this.draw = function() {
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      if (previous != null
        ...
        rect(this.mapYearToWidth(previous.year), this.layout.topMargin, 
             segmentWidth, this.layout.bottomMargin - this.layout.topMargin);
