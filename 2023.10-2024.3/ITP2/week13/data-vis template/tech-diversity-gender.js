  ...
  this.draw = function() {
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      var company = {
        ...
        'name': this.data.getColumn(0)[i],
        'female': parseFloat(this.data.getColumn(1)[i]),
        'male': parseFloat(this.data.getColumn(2)[i])
      };
      ...
      rect(this.layout.rightMargin - this.mapPercentToWidth(company.male),
        lineY,
